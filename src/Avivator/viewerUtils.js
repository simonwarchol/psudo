...
import {getChannelStats, loadBioformatsZarr, loadMultiTiff, loadOmeTiff, loadOmeZarr,} from '@hms-dbmi/viv';
...
export async function getSingleSelectionStats2D({loader, selection}, computeStats = false) {
...
export const getSingleSelectionStats = async ({loader, selection}) => {
...
export const getSquare = (centerX, centerY, width, height) => {
    const data = [[[centerX - width / 2, centerY - height / 2], [centerX - width / 2, centerY + height / 2]],

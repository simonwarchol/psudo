...
import {getMultiSelectionStats, range, truncateDecimalNumber} from '../../../viewerUtils';
...
export default function GlobalSelectionSlider(props) {
    ...
    const [globalSelection, source] = useViewerStore(store => [store.globalSelection, store.source]);

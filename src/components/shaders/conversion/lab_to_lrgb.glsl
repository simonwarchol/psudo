//#pragma glslify: xyz_to_lrgb = require(./xyz_to_lrgb);
//
...
//}
//
//vec3 lab_to_lrgb(vec3 lab) {
//    vec3 xyzd50 = lab_to_xyzd50(lab);
//    vec3 xyzd65 = matrix_xyzd50_xyzd65 * xyzd50;
//    vec3 lrgb = xyz_to_lrgb(xyzd65);
//    return lrgb;
//}
//
//#pragma glslify: export(lab_to_lrgb)
//
